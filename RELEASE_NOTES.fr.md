...
- **Les tailles et les durées s'affichaient en français, quelle que soit la langue de l'application.** Les statistiques du serveur annonçaient « 10j 6h 35min » de disponibilité et « 37,6 Go » envoyés à des utilisateurs anglophones ; les tailles de fichiers du canal faisaient de même. L'espace que le français place avant les deux-points suivait le même chemin : dans les libellés des statistiques, dans la fenêtre de bannissement, et dans chaque ligne de discussion lue par VoiceOver. L'anglais reçoit désormais « 10d 6h 35min », « 37.6 GB » et pas d'espace avant les deux-points ; le français ne bouge pas. Le pied de page des transferts de fichiers était dans le même cas — VoiceOver l'annonçait en français à tout le monde — et il est traduit lui aussi. Signalé par **Ron J.**
